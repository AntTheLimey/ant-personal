...
Personal productivity skills for Claude. Voice-matched writing,
blog creation with automated review, and executive document review
simulation.
...
| Skill | Description |
|-------|-------------|
| **ant-voice-writer** | Write in Ant's voice across professional, creative, academic, and personal contexts. Covers JIRA stories, framing docs, marketing copy, fiction, poetry, worldbuilding, and analytical essays. |
